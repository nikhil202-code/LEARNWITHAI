        ...
        <div className='max-w-4xl mx-auto'>
            ...
            <div className='bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-6 mb-8'>
                <div className='inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-emerald-50 to-teal-50  border-emerald-200 rounded-xl mb-6'>
                    ...
                    <span className='text-sm font-semibold text-emerald-700'>
                        Question<span className='p-1'>{currentQuestionIndex + 1}</span>
                    </span>
                </div>
            ...
            <div className='mt-0 flex items-center justify-center gap-2 flex-wrap'>
                {quiz.questions.map((_, index) => {
                    const isAnswerQuestions = selectedAnswers.hasOwnProperty(quiz.questions[index]._id)
                    ...
                    return (
                        <button
                            ...
                            className={`w-8 h-8 rounded-lg font-semibold text-xs transition-all duration-200 ${isCurrent
                                    ? 'bg-linear-to-r from-emerald-500 to-teal-500 text-white shadow-emerald-500/25 scale-110'
                                    : isAnswerQuestions
