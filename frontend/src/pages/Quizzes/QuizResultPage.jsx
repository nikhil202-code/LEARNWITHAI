                  ...
                  return (
                    <div key={optIndex}
                      ...
                      <div className='flex items-center justify-between gap-3'>
                        <span className={
                          `text-sm font-medium ${isCorrectOption
                            ? 'text-emerald-900'
                            : isWrongAnswer
                              ? 'text-rose-900'
                              : 'text-slate-700'
                        ...
                        <div className='flex items-center gap-2'>
                          {isCorrectOption && (
                            <span className='inline-flex items-center gap-1 py-1 px-2 bg-emerald-100 border border-emerald-300 rounded-lg text-xs font-semibold  text-emerald-700'>
                              <CheckCircle2 className='w-3 h-3' strokeWidth={2.5} />
                              Correct
                            </span>
                          )}
                          {isWrongAnswer && (
                            <span className='inline-flex items-center gap-1 py-1 px-2 bg-rose-100 border border-rose-300 rounded-lg text-xs font-semibold  text-rose-700'>
